...
#define HCQ_OT_HAS_GPIO_FILTER_HEADER 1
#else
#define HCQ_OT_HAS_GPIO_FILTER_HEADER 0
typedef void *gpio_glitch_filter_handle_t;
#endif

#if HCQ_OT_HAS_GPIO_FILTER_HEADER && defined(SOC_GPIO_SUPPORT_PIN_GLITCH_FILTER) && SOC_GPIO_SUPPORT_PIN_GLITCH_FILTER
#define HCQ_OT_GPIO_GLITCH_FILTER_SUPPORTED 1
#else
#define HCQ_OT_GPIO_GLITCH_FILTER_SUPPORTED 0
#endif
...
#define HCQ_OT_RMT_SUPPORTED 1
#include "driver/rmt_common.h"
#include "driver/rmt_encoder.h"
#include "driver/rmt_rx.h"
#include "driver/rmt_tx.h"
#else
#error "hcq_ot_boiler_simulator requires the ESP-IDF RMT driver headers. Use an ESP32 target with esp32.framework.type: esp-idf."
#endif
#include "esp_cpu.h"
...
enum OpenThermMessageID {
	...
	T6CompatProbe70 = 70, // T6 compatibility probe (meaning not implemented here)
	T6CompatProbe72 = 72, // T6 compatibility probe (meaning not implemented here)
	T6CompatProbe82 = 82, // T6 compatibility probe (meaning not implemented here)
